...
my ($help, $outDir, $simPath, $dbPath, $qcPlex, $iniPath, $configPath, $title,
...
### run QC
run($plinkPrefix, $simPath, $dbPath, $iniPath, $configPath, $qcPlex,
...
sub run {
    my ($plinkPrefix, $simPath, $dbPath, $iniPath, $configPath, $qcPlex,
