...
our @fluidigm_subset = ('publish_fluidigm_genotypes.pl',
                        ...
                        'WTSI/NPG/Genotyping/Subscription.pm',
                        'WTSI/NPG/Genotyping/Types.pm',
                        'WTSI/NPG/Genotyping/Sequenom/AssayDataObject.pm',
                        'WTSI/NPG/Genotyping/Sequenom/AssayResult.pm',
                        'WTSI/NPG/Genotyping/Sequenom/AssayResultSet.pm',
                        'WTSI/NPG/Genotyping/Sequenom/Subscriber.pm',
                        'WTSI/NPG/Genotyping/VCF/ReferenceFinder.pm',
